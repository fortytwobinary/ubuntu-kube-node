...
vboxmanage createmedium disk --filename VirtualBox\ VMs/dell-worker1/dell-worker1.vdi --size 100000
...
vboxmanage createmedium disk --filename VirtualBox\ VMs/dell-worker2/dell-worker2.vdi --size 100000
...
vboxmanage createmedium disk --filename VirtualBox\ VMs/dell-worker3/dell-worker3.vdi --size 100000
...
vboxmanage createmedium disk --filename VirtualBox\ VMs/dell-worker4/dell-worker4.vdi --size 100000
